 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Xolo_Hotspot_Notices' ) ) :

	/**
	 * Xolo_Hotspot_Notices
	 *
	 * @since 1.0
	 */
	class Xolo_Hotspot_Notices {
		...
		public function __construct() {
			...
			add_action( 'wp_ajax_xolo-hotspot', array( $this, 'dismiss' ) );
		...
		function enqueue_scripts() {
			wp_register_script( 'xolo-hotspot-notices', XOLO_HOTSPOT_DIR_URL . 'assets/admin/js/xolo-hotspot-notices.js', array( 'jquery' ), XOLO_HOTSPOT_VER, true );
		}
		...
		function show_notices() {
			...
			foreach ( self::$notices as $key => $notice ) {
				...
				$classes = array( 'xolo-hotspots-notice', 'notice' );
				...
				// Notice ID.
				$notice_id = 'xolo-hotspot-notices-id-' . $key;
		...
		public static function markup( $notice = array() ) {
			...
			wp_enqueue_script( 'xolo-hotspot-notices' );
	 ...
	 */
	Xolo_Hotspot_Notices::get_instance();
